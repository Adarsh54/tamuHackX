...
<div style="width: 100%; height: 100%; position: relative; background: linear-gradient(180deg, rgba(220.07, 247.97, 215.53, 0) 0%, rgba(220.07, 247.97, 215.53, 0.31) 14%, #DCF8D8 100%)">
    ...
    <button style="width: 424px; height: 56px; left: 508px; top: 615px; position: absolute">
    ...
    <input style="width: 424px; height: 56px; left: 508px; top: 451px; position: absolute; font-family: Inter; font-size: 20px;">
    ...
    <input style="width: 424px; height: 56px; left: 508px; top: 537px; position: absolute; font-size: 20px;">
        <div style="width: 424px; height: 56px; left: 0px; top: 0px; position: absolute; background: #DCF8D8"></div>
